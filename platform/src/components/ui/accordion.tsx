...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--accordion-panel-height) pt-0 pb-4 transition-[height] duration-200 data-ending-style:h-0 data-starting-style:h-0 [&_a]:text-info [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground [&_p:not(:last-child)]:mb-4",
          className,
        )}
      >
        {children}
